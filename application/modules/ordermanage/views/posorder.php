            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input class="form-control" name ="email" id="email" type="text" placeholder="Customer Email" value=".">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="mobile" class="col-sm-3 col-form-label"><?php echo display('mobile');?> </label>
                  <div class="col-sm-6">
                    <input class="form-control" name ="mobile" id="mobile" type="number" placeholder="Customer Mobile" min="0" value="0">
                  </div>
                </div>
                <div class="form-group row">
