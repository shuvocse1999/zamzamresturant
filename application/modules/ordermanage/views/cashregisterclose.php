                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group text-right">
                    <div class="col-sm-11 pr-0">
                      <button type="button" id="openclosecash" class="btn btn-success w-md m-b-5" onclick="closeandprintcashregister()"><?php echo "Close Resister and print Summery";?></button>
