...
<div class="page-wrapper">
  <div class="invoice-card">
    <div class="invoice-head"> <!--<img src="<?php //echo base_url();?><?php echo $storeinfo->logo?>" alt="">-->
    ...
    <div class="invoice-footer mb-15">
      ...
      <div class="row-data">
        ...
        <h5 class="my-0">
          <?php if($currency->position==1){echo $currency->curr_icon;}?>
          <?php $sdcharge=0; if(empty($billinfo)){ echo $sdcharge;} else{echo $sdcharge=$billinfo->service_charge;} ?>
          <?php if($currency->position==2){echo $currency->curr_icon;}?>
        </h5>
      </div>
      <div class="row-data">
      ...
      <div class="row-data">
        ...
        <h5 class="my-0">
          <?php if($billinfo->bill_status==1){if($currency->position==1){echo $currency->curr_icon;} echo $customepaid; if($currency->position==2){echo $currency->curr_icon;} } else{ if($currency->position==1){echo $currency->curr_icon;} echo $customepaid;if($currency->position==2){echo $currency->curr_icon;} }?>
        </h5>
      </div>
    </div>
    <div class="invoice_address">
      ...
      <div class="middle-data">
                  <div class="text-center">
                    <h5 class="item-title" style="font-size:18px; font-weight:bold;"><?php echo "Payment Status";?>: <?php 
                    if($billinfo->bill_status == 1){
                        echo 'Paid';
                    }else{
