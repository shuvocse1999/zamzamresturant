		...
		<li class="treeview <?php echo (($this->uri->segment(2)=="role" ||$this->uri->segment(2)=="module_permission")?"active":null) ?>">
         ...
         <li class="treeview <?php echo (($this->uri->segment(2)=="setting")?"active":null) ?>">
            ...
            <ul class="treeview-menu">
                ...
                <!--<li><a href="<?php //echo base_url('dashboard/web_setting/delivaryaddress') ?>"><?php //echo display('delv_address')?></a></li>
                <li><a href="<?php //echo base_url('dashboard/web_setting/delivarityme') ?>"><?php //echo display('delvtime')?></a></li>-->
