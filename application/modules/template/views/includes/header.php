    ...
    <span class="top-fixed-link">
        <?php 
           ...
           if(($title=='Home') || ($title2=='dashboard')){
               ?>
               <a href="<?php echo base_url("ordermanage/order/pos_invoice") ?>" class="btn btn-success bg-gradient-custom-teal"><i class="fa fa-plus"></i> <?php echo display('pos_invoice') ?></a>
               <a href="<?php echo base_url("ordermanage/order/orderlist") ?>" class="btn btn-primary bg-gradient-custom-indigo"><i class="fa fa-list"></i> <?php echo display('order_list') ?></a>
               <a href="<?php echo base_url("ordermanage/order/allkitchen") ?>" class="btn btn-warning bg-gradient-custom-pink"><i class="fa fa-user-o" aria-hidden="true"></i> <?php echo display('kitchen_dashboard') ?></a>
               <a href="<?php echo base_url("ordermanage/order/counterboard") ?>" class="btn btn-primary bg-gradient-custom-orange"><i class="fa fa-th"></i> <?php echo display('counter_dashboard') ?></a>
           <?php }  ?>
       </span>
